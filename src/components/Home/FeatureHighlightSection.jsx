...
const features = [
  {
    ...
    description: 'Each project gets a focused team for top quality and efficiency.',
    icon: '/svgs/CheckCircle.svg'
  },
  {
    title: 'Global Talent',
    description: 'Teams across the U.S., Russia, India, China, and Vietnam bring fresh ideas and deep expertise.',
    icon: '/svgs/CheckCircle.svg'
  },
  {
    title: 'Certified Leadership',
    description: 'Certified managers lead with Agile, Waterfall, and Hybrid methodologies.',
    icon: '/svgs/CheckCircle.svg'
  },
  {
    title: 'Data Protection',
    description: 'We follow GDPR and SOC 2 standards to keep your data safe and secure.',
    icon: '/svgs/CheckCircle.svg'
  },
];
...
const certLeadershipItems = [
  ...
  { name: 'Sort Strategy', icon: '/svgs/barchart.svg', bgColor: 'bg-[#D6E6FF]' },
  { name: 'Profit', icon: '/svgs/shakehand.svg', bgColor: 'bg-[#FFE7CB]' },
  { name: 'Continuous improvement', icon: '/svgs/extension.svg', bgColor: 'bg-[#FEECF2]' }
];
...
const FeatureHighlightSection = () => {
  ...
  const leftContentInView = useInView(leftContentRef, { once: true, amount: 0.4 });
  const rightContentInView = useInView(rightContentRef, { once: true, amount: 0.4 });
        ...
        <div className="px-8">
          <div className="grid md:grid-cols-2 gap-4 items-center">
            ...
            <motion.div 
              ...
              whileHover="hover"
            >
              <h1 className="text-[9.5px] text-[#C4C6C5] font-medium">FEATURES</h1>
              <h1 className="text-[12px] text-[#272727] font-medium">Certified Leadership</h1>
              ...
              <div className="w-full mt-2">
                ...
                <div className="border-dotted border-l-[0.69px] border-b-[0.69px] py-[5px] border-[#EDEDED] flex items-center justify-between px-4">
                  ...
                  >
                    ...
                    <h1 className="font-normal text-[9.5px] text-[#545454] whitespace-nowrap">Growth</h1>
                  </motion.div>
                  ...
                  >
                    ...
                    <h1 className="font-normal text-[9.5px] text-[#545454] whitespace-nowrap">Launch</h1>
                  </motion.div>
                </div>
                ...
                >
                  <div className="flex items-center gap-2 bg-[#F6F6F5] rounded-full p-[1.37px] w-fit pr-2">
                    ...
                    <h1 className="font-normal text-[9.5px] text-[#545454] whitespace-nowrap">Sort Strategy</h1>
                  </div>
                </motion.div>
                ...
                <div className="border-dotted border-l-[0.69px] border-b-[0.69px] py-[5px] border-[#EDEDED] flex items-center justify-between px-4">
                  ...
                  >
                    ...
                    <h1 className="font-normal text-[9.5px] text-[#545454] whitespace-nowrap">Profit</h1>
                  </motion.div>
                  ...
                  >
                    ...
                    <h1 className="font-normal text-[9.5px] text-[#545454] whitespace-nowrap">Continuous improvement</h1>
                  </motion.div>
                </div>
              </div>
            </motion.div>
            ...
            <div className="flex flex-col gap-3">
              ...
              >
                <h1 className="text-[9.5px] text-[#C4C6C5] font-medium">FEATURES</h1>
                <h1 className="text-[12px] text-[#272727] font-medium">Data Protection</h1>
                  ...
                  <div className="w-[156px] h-[127px] relative -space-y-16 mx-auto">
                    ...
                    >
                      <div className="flex flex-col bg-gradient-to-br from-[#C0AEFE] border-[0.79px] border-[#4A4DEE] via-[#6D39F3] to-[#3956EB] items-center justify-center rounded-full h-full w-full">
                        <h1 className="font-medium text-[13px] text-white">SOC 2</h1>
                        <h1 className="font-normal text-[8px] text-white">TYPE 1</h1>
                      </div>
                    </motion.div>
                    ...
                    >
                      <div className="bg-gradient-to-br from-[#C0AEFE] border-[0.79px] border-[#4A4DEE] via-[#6D39F3] to-[#3956EB] rounded-full h-full w-full p-[6px]">
                        <div className="flex flex-col items-center justify-center border-[1.59px] border-[rgba(255,255,255,0.38)] border-dashed h-full w-full rounded-full">
                          <h1 className="font-medium text-[13px] text-white">GDPR</h1>
                          <h1 className="font-normal text-[8px] text-white">Compliant</h1>
                        </div>
                      </div>
                    </motion.div>
                  </div>
              ...
              >
                <h1 className="text-[9.5px] text-[#C4C6C5] font-medium">FEATURES</h1>
                <h1 className="text-[12px] text-[#272727] font-medium">Global Talent</h1>
                ...
                <div className="w-full mt-2 border-t-[0.69px] border-[#EDEDED] pt-2 flex flex-col gap-2">
                  {countries.map((country, index) => (
                    <motion.div 
                      ...
                      animate={rightContentInView ? { width: "100%", opacity: 1 } : { width: 0, opacity: 0 }}
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <div className="leading-3">
                          <h1 className="text-[#2A2A2A] text-[9.5px] font-medium">{country.name}</h1>
                          <h2 className="text-[#C4C6C5] text-[8.2px] font-normal">Growth: {country.growth}%</h2>
                        </div>
                      </div>
                      ...
                      <div className="w-[124px] h-2 overflow-hidden bg-[#EEEEEE] rounded-full">
                        <motion.div 
                          ...
                          initial={{ width: 0 }}
                          animate={rightContentInView ? { width: `${country.growth}%` } : { width: 0 }}
