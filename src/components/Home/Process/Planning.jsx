        ...
        <div className="relative md:w-3/4 bg-[#F6F6F9] rounded-[30px] overflow-hidden flex items-center justify-center">
            <div className="w-full overflow-hidden z-10">
                <div className="flex w-fit -translate-x-48 items-center gap-[45px]">
                    {
                        data.map((item, idx) => {
                            return <div key={idx} className={`py-[37px] ${(idx % 2 != 0) ? "w-[413px] mb-32 h-[500px] bg-gradient-to-b from-[#C0AEFE] via-[#6D39F3] to-[#3956EB]" : "w-[368px] mt-32 h-[446px] bg-white"} rounded-[37px] px-[43px] flex flex-col justify-between shadow-md`}>
                                <div>
