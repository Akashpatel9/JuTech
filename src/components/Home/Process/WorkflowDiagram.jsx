...
export default function WorkflowDiagram() {
  ...
  const workflowSteps = [
    {
      id: "01",
      text: "Conduct workshops and interviews."
    },
    {
      id: "02",
      text: "Design system architecture and tech stack."
    },
    {
      id: "03",
      text: "Define user stories with acceptance criteria."
    },
    {
      id: "04",
      text: "Prioritize features."
    }
  ];
