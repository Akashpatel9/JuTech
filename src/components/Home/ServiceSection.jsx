...
const services = {
    "Software Development": {
        ...
        "description": "The Future of Your Financial Solutions and Strategies is not just an exciting and transformative concept it represents a groundbreaking.",
        "svg": "development"

    },
    "Website Development": {
        "E-Commerce": ['W', 'WOO', 'UN'],
        "Frontend": ['HTML', 'CSS', 'REACT', 'ANGULAR', 'VIEW', 'TAILWIND'],
        "Backend": ['NODE', 'PHP', 'ASPDOTNET', 'PYTHON'],
        "description": "W Fully tailored CMS solutions & responsive Design with SEO Optimization",
        "svg": "development1"
    },
    "Mobile App Development": {
        "Cross-Platform (ios & android)": ['FLUTTER', 'WOO'],
        "Native": ['KOTLIN', 'JAVA', 'C'],
        "description": "The Future of Your Financial Solutions and Strategies is not just an exciting and transformative concept it represents a groundbreaking. ",
        "svg": "development2"
    ...
    "Cloud Solutions": {
        "Platforms": ["AWS", "AZORE"],
        "We also work with": ["WINDOWS", "LINUX", "OPENSHIFT", "GITHUB"],
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        Our team brings a wealth of experience and cutting-edge expertise to deliver tailored solutions that drive innovation, efficiency, and growth for your business.
                    </motion.p>
                </motion.div>
            </motion.div>
                ...
                >
                    ...
                    {Object.keys(services).map((service, idx) => (
                        ...
                        >
                            ...
                            >
                                <img className={`${activeService !== service && "opacity-50"}`} width={24} src={`/svgs/${services[service].svg}.svg`} alt="" />
                                {service}
                            </motion.span>
                            <motion.div
                                className="absolute bottom-0 left-0 h-[3px] bg-gradient-to-l from-[#4885EF] via-[#C560CF] to-[#DA5381]"
                                initial={{ width: service === "Software Development" ? "100%" : "0%" }}
                                animate={{
                        ...
                        >
                            ...
                            >
                                <motion.h2
                                    ...
                                    transition={{ duration: 0.3 }}
                                >
                                    <img className="fill-black" width={24} src={`/svgs/${services[activeService].svg}.svg`} alt="" />
                                    {activeService}
                                </motion.h2>
                                <motion.p
                            ...
                            >
                                {Object.entries(activeData).map(([key, value], idx) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <h3 className="text-[16px] font-normal mb-2 capitalize">{key}</h3>
